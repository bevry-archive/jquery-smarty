...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our Plugin definition
		...
		functions: {
			...
			{	// Include and populate a template
				...
				*/
				...
				//console.log('if: ', attributes, result);
			...
			{	// Sections
				...
				var name = attributes.name || Math.random(); // The name of the foreach loop for accessing foreach properties
				// Check
				if ( typeof from !== 'object' )
				{	return '';	}
				// Get length
				...
				$.each(from, function(key, value) {
					...
					// console.log('foreach: ', data.last, data.iteration === data.total, data.iteration, data.total)
					data.item = value;
					data.key = key;
					// Apply
		...
		{	// Assign
			...
			//console.log('assign-0: ', typeof value === 'undefined' && typeof key === 'object', typeof value === 'undefined', typeof key === 'object');
			//console.log('assign-1: ', key, value, preloc);
				...
				switch ( true )
				{
					...
					case (a === '$'):
						...
						{	// Directly accessing smarty
							// console.log('yay: ', loc.substring(10));
